...
CSettings::CSettings(void)
	...
	, NUM_TILES_XAXIS(64)
	, NUM_TILES_YAXIS(64)
	, NUM_TILES_XAXIS_MULTIPLIED(64)
	, NUM_TILES_YAXIS_MULTIPLIED(64)
	, TILE_WIDTH(0.0625f)
...
void CSettings::UpdateSpecifications(void)
{
	...
	NUM_TILES_XAXIS_MULTIPLIED = NUM_TILES_XAXIS * NUM_TILES_MULTIPLIERX;
	NUM_TILES_YAXIS_MULTIPLIED = NUM_TILES_YAXIS * NUM_TILES_MULTIPLIERY;
}
