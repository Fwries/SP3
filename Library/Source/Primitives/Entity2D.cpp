...
void CEntity2D::SetHitBox(bool yes)
{
	hitBox = yes;
}

bool CEntity2D::GetHitBox()
{
	return hitBox;
}

void CEntity2D::SetIsActive(bool yes)
{
	bIsActive = yes;
}

bool CEntity2D::GetIsActive()
{
	//cout << "aaaaaaaaaaaaaa: " << bIsActive << endl;
	return bIsActive;
}
